...
class ContactsTest < ApplicationSystemTestCase
  ...
  test "should create contact" do
    ...
    fill_in "Preferred date", with: @contact.preferred_date
    fill_in "Preferred time", with: @contact.preferred_time
  ...
  test "should update Contact" do
    ...
    fill_in "Phone", with: @contact.phone
    fill_in "Preferred date", with: @contact.preferred_date
    fill_in "Preferred time", with: @contact.preferred_time.to_s
    fill_in "Status", with: @contact.status
