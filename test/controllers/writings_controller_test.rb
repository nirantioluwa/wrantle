...
class WritingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create writing" do
    assert_difference("Writing.count") do
      post writings_url, params: { writing: { published_at: @writing.published_at, slug: @writing.slug, status: @writing.status, title: @writing.title, user_id: @writing.user_id } }
    end
  ...
  test "should update writing" do
    patch writing_url(@writing), params: { writing: { published_at: @writing.published_at, slug: @writing.slug, status: @writing.status, title: @writing.title, user_id: @writing.user_id } }
