class ContactsController < ApplicationController
  ...
  rate_limit to: 2, within: 24.hour, only: :create, with: -> { redirect_to root_path, alert: "We already received 3 messages from you. Trust us, we will get back to you." }
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:name, :email, :phone, :contact_type, :message, :preferred_date, :preferred_time, :status, :contact_email_confirm)
    end
end
